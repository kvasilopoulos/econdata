# Getting help with econdata

Thanks for using econdata. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/econdata/issues) to make sure the 
