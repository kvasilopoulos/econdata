...
- Read, manipulate and store the dataset with the
...
The name of the dataset (and the bibtexkey) should be the initials of
the authors followed by the date of the publication. For examples
`Stock and Watson 2001` should be `sw2001`.
